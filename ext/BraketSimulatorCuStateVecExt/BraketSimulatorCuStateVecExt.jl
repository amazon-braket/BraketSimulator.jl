module BraketSimulatorCuStateVecExt

using BraketSimulator,
    BraketSimulator.Braket,
    BraketSimulator.StatsBase,
    BraketSimulator.StaticArrays,
    BraketSimulator.Combinatorics,
    cuStateVec,
    cuStateVec.CUDA,
    LinearAlgebra
...
import BraketSimulator.Braket: I, Instruction
...
function __init__()
    BraketSimulator.Braket._simulator_devices[]["braket_sv_custatevec"] =
        StateVectorSimulator{ComplexF64,CuVector{ComplexF64}}
    BraketSimulator.Braket._simulator_devices[]["braket_dm_custatevec"] =
