...
const sv_props_dict = Dict(
    ...
    :deviceParameters =>
        Dict(:paradigmParameters => Dict(:qubitCount => sv_qubit_count)),
)

const sv_props = StructTypes.constructfrom(GateModelSimulatorDeviceCapabilities, sv_props_dict)
...
const dm_props_dict = Dict(
    ...
    :action => Dict(
        "braket.ir.openqasm.program" => Dict(
            ...
            :forbiddenPragmas => ["braket_result_type_adjoint_gradient", "braket_result_type_state_vector"],
            :supportedResultTypes => [
                Dict(
                    :name => "Sample",
    ...
    :deviceParameters =>
        Dict(:paradigmParameters => Dict(:qubitCount => dm_qubit_count)),
)
const dm_props = StructTypes.constructfrom(GateModelSimulatorDeviceCapabilities, dm_props_dict)
