...
@testset "Branched Simulator Operators with OpenQASM" begin
    @testset "Basic initialization and simple operations" begin
    ...
    @testset "Mid-circuit measurement" begin
    ...
    @testset "Conditional operations (feedforward)" begin
    ...
    @testset "For loop operations" begin
            ...
            for path_idx in path_indices
                ...
                elseif sum_val == 1
                    ...
                    @test abs(state[2]) ≈ 1.0 atol=1e-10 || abs(state[4]) ≈ 1.0 atol=1e-10 || 
                          ...
                          abs(state[14]) ≈ 1.0 atol=1e-10 || abs(state[16]) ≈ 1.0 atol=1e-10
                elseif sum_val == 2
    ...
    @testset "Additional data types and operations" begin
    ...
    @testset "Type casting operations" begin
